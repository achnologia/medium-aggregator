...
public static class Module
{
    public static IServiceCollection RegisterMediumClient(this IServiceCollection services)
    {
        ...
        services.AddSingleton(sp =>
        {
            ...
            client.DefaultRequestHeaders.Add("medium-frontend-path", "/tag/dotnet");
            client.DefaultRequestHeaders.Add("medium-frontend-route", "tag");
            ...
            client.DefaultRequestHeaders.Add("referer", "https://medium.com/tag/dotnet");
